            ...
            <div class="col col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-left m-0"> {{ ucfirst(__('my-crm::lang.labels')) }}</h3>
                        @can('create crm labels')<span class="float-right"><a type="button" class="btn btn-primary btn-sm" href="{{ url(route('laravel-crm.labels.create')) }}"><span class="fa fa-plus"></span>  {{ ucfirst(__('my-crm::lang.add_label')) }}</a></span>@endcan
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0 card-table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{ ucfirst(__('my-crm::lang.color')) }}</th>
