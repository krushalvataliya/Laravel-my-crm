<div>
    <h6 class="text-uppercase section-h6-title"><span class="fa fa-cart-arrow-down" aria-hidden="true"></span> {{ ucfirst(__('my-crm::lang.order_items')) }} @if(!$fromQuote)<span class="float-right"><button class="btn btn-outline-secondary btn-sm" wire:click.prevent="add({{ $i }})"><span class="fa fa-plus" aria-hidden="true"></span></button></span>@endif</h6>
    <hr class="mb-0" />
        ...
        <div class="table-responsive">
            <table class="table table-sm table-items">
                ...
                @foreach($inputs as $key => $value)
                    @include('my-crm::order-products.partials.fields')
                @endforeach
                </tbody>
