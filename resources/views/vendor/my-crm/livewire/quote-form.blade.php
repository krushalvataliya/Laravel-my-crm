<div>
    <span class="autocomplete">
        ...
        <script type="text/javascript">
            let clients = {!! \Kv\MyCrm\Http\Helpers\AutoComplete\clients() !!}
        </script>
        <span wire:ignore>
            @include('my-crm::partials.form.text',[
                'name' => 'client_name',
                'label' => ucfirst(__('my-crm::lang.client')),
    ...
    @else
        ...
        <span class="autocomplete">
            ...
            <script type="text/javascript">
                let organisations = {!! \Kv\MyCrm\Http\Helpers\AutoComplete\organisations(true) !!}
            </script>
            <span wire:ignore>
                @include('my-crm::partials.form.text',[
