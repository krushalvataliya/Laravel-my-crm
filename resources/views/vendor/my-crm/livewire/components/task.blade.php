    ...
    <div class="card w-100 mb-2">
        <div class="card-body">
            ...
            <div class="media-body">
                <h5 class="mt-0 mb-1">{{ $task->name }} @include('my-crm::livewire.components.partials.task.actions', ['task' => $task])</h5>
                @if($showRelated)
                    <p class="pb-0 mb-2">
                        @if($task->taskable instanceof \Kv\MyCrm\Models\Person)
                        ...
                        @elseif($task->taskable instanceof \Kv\MyCrm\Models\Organisation)
                ...
                @endif
                @include('my-crm::livewire.components.partials.task.content', ['task' => $task])
            </div>
        </div>
    </div>
    @push('livewire-js')
