<div class="form-group @error($name) text-danger @enderror">
    ...
    <div class="autocomplete-control">
        ...
        <div class="input-group">
            ...
            @endisset
        @endif   
        <input id="input_{{ $name }}" type="{{ $type ?? 'text' }}" name="{{ $name }}" value="{{ $value ?? null }}" class="form-control @error($name) is-invalid @enderror" @include('my-crm::partials.form.attributes') >
        @if(isset($prepend) || isset($append))
            @isset($append)
