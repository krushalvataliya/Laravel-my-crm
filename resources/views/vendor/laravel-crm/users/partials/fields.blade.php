<div class="row">
    <div class="col-sm-6 border-right">
        ...
        @include('my-crm::partials.form.password',[
          'name' => 'password',
          'label' => ucfirst(__('my-crm::lang.password')),
          'value' => old('password'),
          'required' => 'true'
        ])
        @include('my-crm::partials.form.password',[
          'name' => 'password_confirmation',
          'label' => ucfirst(__('my-crm::lang.confirm_password')),
          'value' => old('password_confirmation'),
          'required' => 'true'
        ])
        <div class="form-group">
            <label for="crm_access">{{ ucfirst(__('my-crm::lang.CRM_access')) }}</label>
        ...
        @if(isset($user) && $user->isCrmOwner())
            @include('my-crm::partials.form.select',[
               'name' => 'role',
               'label' => ucfirst(__('my-crm::lang.CRM_role')),
               'options' => \Kv\MyCrm\Http\Helpers\SelectOptions\optionsFromModel(Kv\MyCrm\Models\Role::crm()->when(config('laravel-crm.teams'), function ($query) {
        ...
        @hasteamsenabled
        <h6 class="text-uppercase mt-4 section-h6-title">{{ ucfirst(__('my-crm::lang.teams')) }}</h6>
        <hr>
        @include('my-crm::partials.form.multiselect',[
            'name' => 'user_teams',
            'label' => null,
            'options' => \Kv\MyCrm\Http\Helpers\SelectOptions\optionsFromModel($teams, null),
