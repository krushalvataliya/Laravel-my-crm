<span>
    @can('edit crm invoices')
        <a href="{{ route('laravel-crm.invoices.send',$this->invoice) }}" data-toggle="modal" data-target="#invoiceSendModal_{{ $this->invoice->id }}" class="btn btn-outline-secondary btn-sm">{{ ucfirst(__('my-crm::lang.send')) }}</a>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="invoiceSendModalLabel">{{ ucfirst(__('my-crm::lang.send_invoice')) }} </h5>
