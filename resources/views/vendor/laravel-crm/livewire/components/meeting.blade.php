    ...
    <div class="card w-100 mb-2">
        <div class="card-body">
            ...
            <div class="media-body">
                <h5 class="mt-0 mb-1">{{ $meeting->name }} @include('my-crm::livewire.components.partials.meeting.actions', ['meeting' => $meeting])</h5>
                @if($showRelated)
                    <p class="pb-0 mb-2">
                        @if($meeting->meetingable instanceof \Kv\MyCrm\Models\Person)
                        ...
                        @elseif($meeting->meetingable instanceof \Kv\MyCrm\Models\Organisation)
                ...
                @endif
                @include('my-crm::livewire.components.partials.meeting.content', ['meeting' => $meeting])
            </div>
        </div>
    </div>
    @push('livewire-js')
