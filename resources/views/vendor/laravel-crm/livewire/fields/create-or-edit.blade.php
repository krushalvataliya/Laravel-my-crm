                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title float-left m-0">
                                @if($field)
                                    {{ ucfirst(trans('my-crm::lang.edit_custom_field')) }}
                                @else
                                    {{ ucfirst(trans('my-crm::lang.create_custom_field')) }}
                                @endif
                            </h3>
                            <span class="float-right"><a type="button" class="btn btn-outline-secondary btn-sm" href="{{ url(route('laravel-crm.fields.index')) }}"><span class="fa fa-angle-double-left"></span> {{ ucfirst(trans('my-crm::lang.back_to_fields')) }}</a></span>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                            ...
                                            <div class="card mb-3">
                                                ...
                                                <div class="card-body p-0">
                                                    <table class="table table-items pb-0 mb-0">
                                                        ...
                                                        <tfoot>
                                                        <tr>
                                                            <td colspan="3"><button class="btn btn-outline-secondary btn-sm" wire:click.prevent="addOption()"><span class="fa fa-plus" aria-hidden="true"></span> {{ ucfirst(__('my-crm::lang.add_option')) }}</button></td>
                                                        </tr>
                                                        </tfoot>
                                                    </table>
                        ...
                        @component('my-crm::components.card-footer')
                            ...
                            <button type="submit" class="btn btn-primary">
                                @if($field)
                                    {{ ucfirst(trans('my-crm::lang.save_changes')) }}
                                @else
                                    {{ ucfirst(trans('my-crm::lang.save')) }}
                                @endif
                            </button>
                        @endcomponent
                    </div>
