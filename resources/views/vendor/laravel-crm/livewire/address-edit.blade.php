<div class="addresses">
    <h6 class="text-uppercase mt-4 section-h6-title"><span>{{ ucfirst(__('my-crm::lang.addresses')) }}</span> @if(!in_array($model, ['order','delivery']))<span class="float-right"><button class="btn btn-outline-secondary btn-sm" wire:click.prevent="add({{$i}})"><span class="fa fa-plus" aria-hidden="true"></span></button></span>@endif</h6>
    <hr />
        ...
        <div class="form-row">
            <div class="@if(!in_array($model, ['order','delivery'])) col-sm-10 @else col-sm-12 @endif">
                ...
                <div class="form-group">
                    <label>{{ ucfirst(__('my-crm::lang.type')) }}</label>
                    ...
                    @else    
                        <select class="form-control custom-select" wire:model="type.{{ $value }}" name="addresses[{{ $value }}][type]" @if(in_array($model, ['order','delivery'])) disabled="disabled" @endif>
                            @foreach(\Kv\MyCrm\Http\Helpers\SelectOptions\optionsFromModel(\Kv\MyCrm\Models\AddressType::all()) as $optionKey => $optionName)
                ...
                {{--  <div class="form-group">
                      <label>{{ ucfirst(__('my-crm::lang.address')) }}</label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ ucfirst(__('my-crm::lang.contact_name')) }}</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ ucfirst(__('my-crm::lang.contact_phone')) }}</label>
                ...
                <div class="form-group">
                    <label>{{ ucfirst(__('my-crm::lang.line_1')) }}</label>
                ...
                <div class="form-group">
                    <label>{{ ucfirst(__('my-crm::lang.line_2')) }}</label>
                ...
                <div class="form-group">
                    <label>{{ ucfirst(__('my-crm::lang.line_3')) }}</label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ ucfirst(__('my-crm::lang.suburb')) }}</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ ucfirst(__('my-crm::lang.state')) }}</label>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ ucfirst(__('my-crm::lang.postcode')) }}</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>{{ ucfirst(__('my-crm::lang.country')) }}</label>
                            <select class="form-control custom-select" wire:model="country.{{ $value }}" name="addresses[{{ $value }}][country]">
                                @foreach(\Kv\MyCrm\Http\Helpers\SelectOptions\countries() as $optionKey => $optionName)
                                    <option value="{{ $optionKey }}">{{ $optionName }}</option>
                                @endforeach
                            </select>
            ...
            <div class="col-sm-1">
                <div class="form-group" wire:ignore>
                    <label>{{ ucfirst(__('my-crm::lang.primary')) }}</label>
