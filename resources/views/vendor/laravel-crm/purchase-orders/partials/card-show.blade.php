    ...
    @component('my-crm::components.card-header')
        ...
        @slot('actions')
            <span class="float-right">
                ...
                <a class="btn btn-outline-secondary btn-sm" href="{{ route('laravel-crm.purchase-orders.download', $purchaseOrder) }}">{{ ucfirst(__('my-crm::lang.download')) }}</a>
    ...
    @component('my-crm::components.card-body')
        ...
        <div class="row card-show card-fa-w30">
            <div class="col-sm-6 border-right">
                ...
                <h6 class="text-uppercase mt-4 section-h6-title-table"><span>{{ ucfirst(__('my-crm::lang.purchase_order_lines')) }} ({{ $purchaseOrder->purchaseOrderLines->count() }})</span></h6>
