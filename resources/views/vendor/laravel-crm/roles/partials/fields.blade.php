<div class="row">
    ...
    <div class="col-sm-6">
        <table class="table mb-0 card-table table-hover">
            <thead>
            <tr>
                <th scope="col">{{ ucwords(__('my-crm::lang.permission')) }}</th>
                <th scope="col">{{ ucwords(__('my-crm::lang.description')) }}</th>
                <th scope="col" class="text-right">{{ ucwords(__('my-crm::lang.has_permission')) }}</th>
            </tr>
            </thead>
            <tbody>
