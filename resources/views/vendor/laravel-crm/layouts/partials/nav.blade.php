    ...
    <div class="card-body py-3 px-2">
        <ul class="nav nav-pills nav-side flex-column">
            ...
            @can('view crm projects')
                <li class="nav-item"><a class="nav-link {{ (strpos(Route::currentRouteName(), 'laravel-crm.projects') === 0) ? 'active' : '' }}" href="{{ url(route('laravel-crm.projects.index')) }}">{{ ucfirst(__('my-crm::lang.projects')) }}</a></li>
            @endcan
            @hasinvoicesenabled
