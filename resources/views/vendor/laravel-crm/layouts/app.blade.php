...
<head>
    ...
    @include('my-crm::layouts.partials.meta')
    ...
    @include('my-crm::layouts.partials.favicon')
</head>
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm fixed-top">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <!-- Left Side Of Navbar -->
                        @include('my-crm::layouts.partials.search')
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            @guest
                                ...
                                @endif
                            @else
                                @include('my-crm::layouts.partials.nav-user')  
                            @endguest
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col col-md-2">
                       @include('my-crm::layouts.partials.nav')
                    </div>
                    @endauth
