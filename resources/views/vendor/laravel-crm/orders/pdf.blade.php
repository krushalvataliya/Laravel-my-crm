...
@section('content')
    ...
    <table class="table table-sm table-items">
        <tbody>
            <tr>
                <td width="50%"> 
                    <h1>{{ strtoupper(__('my-crm::lang.order')) }}</h1>
                    @if($order->order_id)
                        <strong>{{ ucfirst(__('my-crm::lang.number')) }}</strong> {{ $order->order_id }}<br />
                    @endif
                    @if($order->reference)
                        <p><strong>{{ ucfirst(__('my-crm::lang.reference')) }}</strong> {{ $order->reference }}</p>
                    @endif
                </td>
