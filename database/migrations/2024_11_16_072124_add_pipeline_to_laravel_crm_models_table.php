...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table(config('laravel-crm.db_table_prefix').'leads', function (Blueprint $table) {
            $table->foreignIdFor(\Kv\MyCrm\Models\Pipeline::class)->nullable()->after('team_id');
            $table->foreignIdFor(\Kv\MyCrm\Models\PipelineStage::class)->nullable()->after('pipeline_id');
        });
