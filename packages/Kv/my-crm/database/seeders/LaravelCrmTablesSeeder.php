...
class LaravelCrmTablesSeeder extends Seeder
{
    ...
    {
        // Labels
        if(! \Kv\MyCrm\Models\Setting::where('name', 'db_seeded_labels')->first()) {
            $items = [
                [
                    [
                        'id' => 1,
            ...
            foreach ($items as $item) {
                \Kv\MyCrm\Models\Label::firstOrCreate($item[0], $item[1]);
            }
        ...
        if(! \Kv\MyCrm\Models\Setting::where('name', 'db_seeded_lead_statuses')->first()) {
            $items = [
                [
                    [
                        'id' => 1,
            ...
            foreach ($items as $item) {
                \Kv\MyCrm\Models\LeadStatus::firstOrCreate($item[0], $item[1]);
            }
        ...
        // Organisation Types
        if(! \Kv\MyCrm\Models\Setting::where('name', 'db_seeded_organisation_types')->first()) {
            $items = [
                [
                    [
                        'id' => 1,
            ...
            foreach ($items as $item) {
                \Kv\MyCrm\Models\OrganisationType::firstOrCreate($item[0], $item[1]);
            }
        ...
        // Address types
        if(! \Kv\MyCrm\Models\Setting::where('name', 'db_seeded_address_types')->first()) {
            $items = [
                [
                    [
                        'id' => 1,
            ...
            foreach ($items as $item) {
                \Kv\MyCrm\Models\AddressType::firstOrCreate($item[0], $item[1]);
            }
        ...
        // Contact types
        if(! \Kv\MyCrm\Models\Setting::where('name', 'db_seeded_contact_types')->first()) {
            $items = [
                [
                    [
                        'id' => 1,
            ...
            foreach ($items as $item) {
                \Kv\MyCrm\Models\ContactType::firstOrCreate($item[0], $item[1]);
            }
        ...
        foreach (timezone_identifiers_list() as $zone) {
            ...
            \Kv\MyCrm\Models\Timezone::updateOrCreate(['name' => $zone], $zones);
        }
