...
class LaravelCrmPipelineTablesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if(! \Kv\MyCrm\Models\Setting::where('name', 'db_seeded_pipeline_probabilities')->first()) {
            $items = [
                [
                    [
                        'id' => 1,
            ...
            foreach ($items as $item) {
                \Kv\MyCrm\Models\PipelineStageProbability::firstOrCreate($item[0], $item[1]);
            }
        ...
        // Pipelines
        if(! \Kv\MyCrm\Models\Setting::where('name', 'db_seeded_pipelines')->first()) {
            $items = [
                [
                    [
                        'id' => 1,
            ...
            foreach ($items as $item) {
                \Kv\MyCrm\Models\Pipeline::firstOrCreate($item[0], $item[1]);
            }
        ...
        // Pipelines stages
        if(! \Kv\MyCrm\Models\Setting::where('name', 'db_seeded_pipelines_stages')->first()) {
            $items = [
                // Leads
                [
                    [
            ...
            foreach ($items as $item) {
                \Kv\MyCrm\Models\PipelineStage::firstOrCreate($item[0], $item[1]);
            }
