...
namespace Kv\MyCrm\Http\Helpers\SelectOptions;

use App\User;
use Carbon\Carbon;
use Rinvex\Country\CountryLoader;
use Rinvex\Country\CurrencyLoader;
use Kv\MyCrm\Models\Timezone;
...
{
    return [
        'Kv\MyCrm\Models\Lead' => ucfirst(__('my-crm::lang.leads')),
        'Kv\MyCrm\Models\Deal' => ucfirst(__('my-crm::lang.deals')),
        'Kv\MyCrm\Models\Quote' => ucfirst(__('my-crm::lang.quotes')),
        'Kv\MyCrm\Models\Order' => ucfirst(__('my-crm::lang.orders')),
        'Kv\MyCrm\Models\Person' => ucfirst(__('my-crm::lang.people')),
        'Kv\MyCrm\Models\Organisation' => ucfirst(__('my-crm::lang.organizations')),
        'Kv\MyCrm\Models\Product' => ucfirst(__('my-crm::lang.products')),
    ];
}
