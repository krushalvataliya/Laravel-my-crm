...
use Kv\MyCrm\Http\Requests\StorePipelineStageRequest;
use Kv\MyCrm\Http\Requests\UpdatePipelineStageRequest;
...
class PipelineStageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('my-crm::pipeline-stages.index', [
    ...
    {
        return view('my-crm::pipeline-stages.create');
    }
    ...
    public function store(StorePipelineStageRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.pipeline_stage_stored')))->success()->important();
    ...
    {
        return view('my-crm::pipeline-stages.show', [
    ...
    {
        return view('my-crm::pipeline-stages.edit', [
            'pipelineStage' => $pipelineStage,
        ]);
    }
    ...
    public function update(UpdatePipelineStageRequest $request, PipelineStage $pipelineStage)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.pipeline_stage_updated')))->success()->important();
    ...
    public function destroy(PipelineStage $pipelineStage)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.pipeline_stage_deleted')))->success()->important();
