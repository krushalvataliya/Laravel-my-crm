...
use App\User;
use Kv\MyCrm\Http\Requests\StoreFieldGroupRequest;
use Kv\MyCrm\Http\Requests\UpdateFieldGroupRequest;
...
class FieldGroupController extends Controller
{
    ...
    public function index(User $user)
    {
        ...
        return view('my-crm::field-groups.index', [
    ...
    {
        return view('my-crm::field-groups.create');
    }
    ...
    public function store(StoreFieldGroupRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.field_group_stored')))->success()->important();
    ...
    {
        return view('my-crm::field-groups.show', [
    ...
    {
        return view('my-crm::field-groups.edit', [
            'fieldGroup' => $fieldGroup,
        ]);
    }
    ...
    public function update(UpdateFieldGroupRequest $request, FieldGroup $fieldGroup)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.field_group_updated')))->success()->important();
    ...
    public function destroy(FieldGroup $fieldGroup)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.field_group_deleted')))->success()->important();
