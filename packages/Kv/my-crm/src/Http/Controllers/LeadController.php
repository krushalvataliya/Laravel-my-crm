...
use Kv\MyCrm\Http\Requests\StoreLeadRequest;
use Kv\MyCrm\Http\Requests\UpdateLeadRequest;
...
use Kv\MyCrm\Services\LeadService;
...
class LeadController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::leads.index', [
            'leads' => $leads,
    ...
    public function create(Request $request)
    {
        ...
        return view('my-crm::leads.create', [
            'client' => $client ?? null,
    ...
    public function store(StoreLeadRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.lead_stored')))->success()->important();
    ...
    public function update(UpdateLeadRequest $request, Lead $lead)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.lead_updated')))->success()->important();
    ...
    public function destroy(Lead $lead)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.lead_deleted')))->success()->important();
    ...
    public function search(Request $request)
    {
        ...
        if($viewSetting->value === 'board') {
            return view('my-crm::leads.board', [
                'leads' => $leads,
    ...
    public function convertToDeal(Lead $lead)
    {
        ...
        return view('my-crm::leads.convert', [
            'lead' => $lead,
            'email' => $email ?? null,
            'phone' => $phone ?? null,
            'address' => $address ?? null,
    ...
    public function storeAsDeal(StoreLeadRequest $request, Lead $lead)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.lead_converted_to_deal')))->success()->important();
