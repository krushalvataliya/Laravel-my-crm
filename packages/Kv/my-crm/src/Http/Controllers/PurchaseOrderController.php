...
use Kv\MyCrm\Http\Requests\StorePurchaseOrderRequest;
use Kv\MyCrm\Http\Requests\UpdatePurchaseOrderRequest;
use Kv\MyCrm\Models\PurchaseOrder;
use Kv\MyCrm\Models\Order;
use Kv\MyCrm\Models\Organisation;
use Kv\MyCrm\Models\Person;
use Kv\MyCrm\Services\PurchaseOrderService;
...
class PurchaseOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::purchase-orders.index', [
    ...
    public function create(Request $request)
    {
        ...
        return view('my-crm::purchase-orders.create', [
            'person' => $person ?? null,
    ...
    public function store(StorePurchaseOrderRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.purchase_order_created')))->success()->important();
    ...
    public function storeMultiple(StorePurchaseOrderRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.purchase_orders_created')))->success()->important();
    ...
    public function show(PurchaseOrder $purchaseOrder)
    {
        ...
        return view('my-crm::purchase-orders.show', [
    ...
    public function edit(PurchaseOrder $purchaseOrder)
    {
        ...
        return view('my-crm::purchase-orders.edit', [
            'purchaseOrder' => $purchaseOrder,
            'email' => $email ?? null,
            'phone' => $phone ?? null,
            'address' => $address ?? null,
    ...
    public function update(UpdatePurchaseOrderRequest $request, PurchaseOrder $purchaseOrder)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.purchase_order_updated')))->success()->important();
    ...
    public function destroy(PurchaseOrder $purchaseOrder)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.purchase_order_deleted')))->success()->important();
    ...
    public function download(PurchaseOrder $purchaseOrder)
    {
        ...
        return Pdf::setOption([
            ...
            ->loadView('my-crm::purchase-orders.pdf', [
                'purchaseOrder' => $purchaseOrder,
