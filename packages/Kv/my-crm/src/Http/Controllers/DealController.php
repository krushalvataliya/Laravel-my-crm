...
use Kv\MyCrm\Http\Requests\StoreDealRequest;
use Kv\MyCrm\Http\Requests\UpdateDealRequest;
...
use Kv\MyCrm\Services\DealService;
...
class DealController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::deals.index', [
            'deals' => $deals,
    ...
    public function create(Request $request)
    {
        ...
        return view('my-crm::deals.create', [
            'client' => $client ?? null,
    ...
    public function store(StoreDealRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.deal_stored')))->success()->important();
    ...
    public function update(UpdateDealRequest $request, Deal $deal)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.deal_updated')))->success()->important();
    ...
    public function destroy(Deal $deal)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.deal_deleted')))->success()->important();
    ...
    public function search(Request $request)
    {
        ...
        if($viewSetting->value === 'board') {
            return view('my-crm::deals.board', [
                'deals' => $deals,
    ...
    public function won(Deal $deal)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.deal_won')))->success()->important();
    ...
    public function lost(Deal $deal)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.deal_lost')))->success()->important();
    ...
    public function reopen(Deal $deal)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.deal_reopened')))->success()->important();
