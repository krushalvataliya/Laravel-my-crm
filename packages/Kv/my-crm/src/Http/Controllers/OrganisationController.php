...
use Kv\MyCrm\Http\Requests\StoreOrganisationRequest;
use Kv\MyCrm\Http\Requests\UpdateOrganisationRequest;
...
class OrganisationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::organisations.index', [
    ...
    {
        return view('my-crm::organisations.create');
    }
    ...
    public function store(StoreOrganisationRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.organization_stored')))->success()->important();
    ...
    {
        return view('my-crm::organisations.show', [
    ...
    {
        return view('my-crm::organisations.edit', [
            'organisation' => $organisation,
            'emails' => $organisation->emails,
            'phones' => $organisation->phones,
            'addresses' => $organisation->addresses,
    ...
    public function update(UpdateOrganisationRequest $request, Organisation $organisation)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.organization_updated')))->success()->important();
    ...
    public function destroy(Organisation $organisation)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.organization_deleted')))->success()->important();
