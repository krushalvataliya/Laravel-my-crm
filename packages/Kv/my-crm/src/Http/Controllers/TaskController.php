...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('my-crm::tasks.index', [
            'tasks' => $tasks ?? [],
        ]);
    }
    ...
    public function destroy(Task $task)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.task_deleted')))->success()->important();
    ...
    public function complete(Task $task)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.task_completed')))->success()->important();
