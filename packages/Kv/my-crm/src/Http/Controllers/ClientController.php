...
use Kv\MyCrm\Http\Requests\StoreClientRequest;
use Kv\MyCrm\Http\Requests\UpdateClientRequest;
...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::clients.index', [
            'clients' => $clients,
        ]);
    }
    ...
    {
        return view('my-crm::clients.create');
    }
    ...
    public function store(StoreClientRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.client_stored')))->success()->important();
    ...
    {
        return view('my-crm::clients.show', [
             'client' => $client,
         ]);
    }
    ...
    {
        return view('my-crm::clients.edit', [
             'client' => $client,
         ]);
    }
    ...
    public function update(UpdateClientRequest $request, Client $client)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.client_updated')))->success()->important();
    ...
    public function destroy(Client $client)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.client_deleted')))->success()->important();
