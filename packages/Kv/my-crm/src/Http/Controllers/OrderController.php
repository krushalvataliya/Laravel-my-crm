...
use Kv\MyCrm\Http\Requests\StoreOrderRequest;
use Kv\MyCrm\Http\Requests\UpdateOrderRequest;
...
use Kv\MyCrm\Services\InvoiceService;
...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::orders.index', [
            'orders' => $orders,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('my-crm::orders.create', [
            'quote' => $quote ?? null,
            'client' => $client ?? null,
    ...
    public function store(StoreOrderRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.order_stored')))->success()->important();
    ...
    public function show(Order $order)
    {
        ...
        return view('my-crm::orders.show', [
            'order' => $order,
            'email' => $email ?? null,
            'phone' => $phone ?? null,
    ...
    public function edit(Order $order)
    {
        ...
        return view('my-crm::orders.edit', [
            'order' => $order,
            'email' => $email ?? null,
            'phone' => $phone ?? null,
            'organisation_address' => $address ?? null,
    ...
    public function update(UpdateOrderRequest $request, Order $order)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.order_updated')))->success()->important();
    ...
    public function destroy(Order $order)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.order_deleted')))->success()->important();
    ...
    public function createDelivery(Order $order)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.delivery_created_from_order')))->success()->important();
