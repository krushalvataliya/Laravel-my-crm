...
use Kv\MyCrm\Http\Requests\StoreProductRequest;
use Kv\MyCrm\Http\Requests\UpdateProductRequest;
use Kv\MyCrm\Models\Product;
use Kv\MyCrm\Services\ProductService;
...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::products.index', [
            'products' => $products,
        ]);
    }
    ...
    {
        return view('my-crm::products.create');
    }
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.product_stored')))->success()->important();
    ...
    {
        return view('my-crm::products.show', [
            'product' => $product,
        ]);
    }
    ...
    {
        return view('my-crm::products.edit', [
            'product' => $product,
        ]);
    }
    ...
    public function update(UpdateProductRequest $request, Product $product)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.product_updated')))->success()->important();
    ...
    public function destroy(Product $product)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.product_deleted')))->success()->important();
