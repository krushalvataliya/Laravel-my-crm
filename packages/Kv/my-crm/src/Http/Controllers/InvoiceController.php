...
use Kv\MyCrm\Http\Requests\StoreInvoiceRequest;
use Kv\MyCrm\Http\Requests\UpdateInvoiceRequest;
...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::invoices.index', [
            'invoices' => $invoices,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('my-crm::invoices.create', [
            'person' => $person ?? null,
    ...
    public function store(StoreInvoiceRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.invoice_created')))->success()->important();
    ...
    public function show(Invoice $invoice)
    {
        ...
        return view('my-crm::invoices.show', [
            'invoice' => $invoice,
            'email' => $email ?? null,
            'phone' => $phone ?? null,
    ...
    public function edit(Invoice $invoice)
    {
        ...
        return view('my-crm::invoices.edit', [
            'invoice' => $invoice,
            'email' => $email ?? null,
            'phone' => $phone ?? null,
            'address' => $address ?? null,
    ...
    public function update(UpdateInvoiceRequest $request, Invoice $invoice)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.invoice_updated')))->success()->important();
    ...
    public function destroy(Invoice $invoice)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.invoice_deleted')))->success()->important();
