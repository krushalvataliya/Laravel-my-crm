...
use Kv\MyCrm\Http\Requests\InviteUserRequest;
use Kv\MyCrm\Http\Requests\StoreUserRequest;
use Kv\MyCrm\Http\Requests\UpdateUserRequest;
use Kv\MyCrm\Models\Address;
use Kv\MyCrm\Models\Email;
use Kv\MyCrm\Models\Phone;
use Kv\MyCrm\Models\Role;
use Kv\MyCrm\Models\Team;
...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('my-crm::users.index', [
            'users' => $users ?? [],
        ]);
    }
    ...
    {
        return view('my-crm::users.invite');
    }
    ...
    {
        flash(ucfirst(trans('my-crm::lang.user_invitation_sent')))->success()->important();
    ...
    public function create()
    {
        ...
        return view('my-crm::users.create', [
            'teams' => $teams,
        ]);
    }
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.user_stored')))->success()->important();
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.user_updated')))->success()->important();
    ...
    public function destroy(User $user)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.user_deleted')))->success()->important();
