...
use Kv\MyCrm\Http\Requests\StorePersonRequest;
use Kv\MyCrm\Http\Requests\UpdatePersonRequest;
...
class PersonController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('my-crm::people.index', [
            'people' => $people,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('my-crm::people.create', [
    ...
    public function store(StorePersonRequest $request)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.person_stored')))->success()->important();
    ...
    public function show(Person $person)
    {
        ...
        return view('my-crm::people.show', [
            'person' => $person,
    ...
    {
        return view('my-crm::people.edit', [
            'person' => $person,
            'emails' => $person->emails,
            'phones' => $person->phones,
            'addresses' => $person->addresses,
    ...
    public function update(UpdatePersonRequest $request, Person $person)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.person_updated')))->success()->important();
    ...
    public function destroy(Person $person)
    {
        ...
        flash(ucfirst(trans('my-crm::lang.person_deleted')))->success()->important();
