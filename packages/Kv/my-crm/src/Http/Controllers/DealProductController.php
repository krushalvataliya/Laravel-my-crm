...
use Kv\MyCrm\Models\DealProduct;
...
class DealProductController extends Controller
{
    ...
    public function create(Deal $deal)
    {
        ...
        return view('my-crm::deal-products.create', [
    ...
    {
        return view('my-crm::deal-products.create-product', [
            'index' => rand(),
        ]);
    }
    ...
    {
        return view('my-crm::deal-products.edit');
    }
