...
class SendPurchaseOrder extends Component
{
    ...
    public function mount($purchaseOrder)
    {
        ...
        $this->subject = view('my-crm::mail.templates.send-purchase-order.subject', ['purchaseOrder' => $this->purchaseOrder])->render();
        $this->message = view('my-crm::mail.templates.send-purchase-order.message', ['purchaseOrder' => $this->purchaseOrder])->render();
    }
    ...
    public function send()
    {
        ...
        Mail::send(new \Kv\MyCrm\Mail\SendPurchaseOrder([
            'to' => $this->to,
    ...
    {
        return view('my-crm::livewire.send-purchase-order');
    }
}
