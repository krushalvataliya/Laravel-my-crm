...
class SendQuote extends Component
{
    ...
    public function mount($quote)
    {
        ...
        $this->subject = view('my-crm::mail.templates.send-quote.subject', ['quote' => $this->quote])->render();
        $this->message = view('my-crm::mail.templates.send-quote.message', ['quote' => $this->quote])->render();
    }
    ...
    public function send()
    {
        ...
        Mail::send(new \Kv\MyCrm\Mail\SendQuote([
            'to' => $this->to,
    ...
    {
        return view('my-crm::livewire.send-quote');
    }
}
