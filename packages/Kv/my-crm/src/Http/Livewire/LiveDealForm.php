...
class LiveDealForm extends Component
{
    ...
    public function generateTitle()
    {
        if ($this->generateTitle) {
            if ($this->client_name) {
                $this->title = $this->client_name . ' ' . ucfirst(trans('my-crm::lang.deal'));
            } elseif ($this->organisation_name) {
                $this->title = $this->organisation_name . ' ' . ucfirst(trans('my-crm::lang.deal'));
            } elseif ($this->person_name) {
                $this->title = $this->person_name . ' ' . ucfirst(trans('my-crm::lang.deal'));
            }
        }
    }
    ...
    {
        return view('my-crm::livewire.deal-form');
    }
}
