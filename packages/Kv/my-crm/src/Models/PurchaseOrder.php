...
class PurchaseOrder extends Model
{
    ...
    {
        return $this->hasMany(\Kv\MyCrm\Models\PurchaseOrderLine::class);
    }
    ...
    {
        return $this->hasOne(\Kv\MyCrm\Models\XeroPurchaseOrder::class);
    }

    public function address()
    {
        return $this->morphOne(\Kv\MyCrm\Models\Address::class, 'addressable');
    }
}
