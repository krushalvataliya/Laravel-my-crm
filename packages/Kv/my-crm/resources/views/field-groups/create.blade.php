            ...
            <div class="col col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title float-left m-0">{{ ucfirst(trans('my-crm::lang.create_custom_field_group')) }}</h3>
                    ...
                    @component('my-crm::components.card-footer')
                        <a href="{{ url(route('laravel-crm.field-groups.index')) }}" class="btn btn-outline-secondary">{{ ucfirst(trans('my-crm::lang.cancel')) }}</a>
