    ...
    @component('my-crm::components.card-table')
        ...
        <table class="table mb-0 card-table table-hover">
            ...
            <tr>
                ...
                <th scope="col">{{ ucwords(__('my-crm::lang.issue_at')) }}</th>
                <th scope="col">{{ ucwords(__('my-crm::lang.expire_at')) }}</th>
            ...
            @foreach($quotes as $quote)
               ...
               <tr class="has-link @if($quote->accepted_at) table-success @elseif($quote->rejected_at) table-danger @endif" data-url="{{ url(route('laravel-crm.quotes.show',$quote)) }}">
                   ...
                   <td>{{ $quote->ownerUser->name ?? ucfirst(__('my-crm::lang.unallocated')) }}</td>
                       ...
                       @can('edit crm quotes')
                           ...
                           @else    
                               @if(!$quote->accepted_at && !$quote->rejected_at)
                                   <a href="{{ route('laravel-crm.quotes.accept',$quote) }}" class="btn btn-success btn-sm">{{ ucfirst(__('my-crm::lang.accept')) }}</a>
                                   <a href="{{ route('laravel-crm.quotes.reject',$quote) }}" class="btn btn-danger btn-sm">{{ ucfirst(__('my-crm::lang.reject')) }}</a>
