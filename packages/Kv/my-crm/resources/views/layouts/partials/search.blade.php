<form role="search" method="get" action="@php
     ...
     if(strpos(Route::currentRouteName(), 'laravel-crm.leads') === 0 && auth()->user()->can('view crm leads')){
        ...
        $currentAction = ucfirst(__('my-crm::lang.leads'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.deals'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.quotes'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.orders'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.clients'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.people'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.organizations'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.products'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.invoices'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.deliveries'));
         ...
         $currentAction = ucfirst(__('my-crm::lang.purchase_orders'));
     }
...
@endphp" name="formSearch" class="navbar-form-custom">
    ...
    <div class="input-group">
        ...
        <div class="input-group-append">
            <button class="btn btn-outline-secondary" type="submit"><i class="fa fa-search"></i> <span class="action-current">{{ $currentAction ?? ucfirst(__('my-crm::lang.leads')) }}</span></button>
            <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
            <div class="dropdown-menu dropdown-menu-right">
                @hasleadsenabled
                @can('view crm leads')
                <a class="dropdown-item" href="#leads" data-type="leads" data-action="{{ url(route('laravel-crm.leads.search')) }}">{{ ucfirst(__('my-crm::lang.leads')) }}</a>
                @endcan
                @endhasleadsenabled
                @hasdealsenabled
                @can('view crm deals')
                <a class="dropdown-item" href="#deals" data-type="deals" data-action="{{ url(route('laravel-crm.deals.search')) }}">{{ ucfirst(__('my-crm::lang.deals')) }}</a>
                @endcan
                @endhasdealsenabled
                @hasquotesenabled
                @can('view crm quotes')
                    <a class="dropdown-item" href="#quotes" data-type="quotes" data-action="{{ url(route('laravel-crm.quotes.search')) }}">{{ ucfirst(__('my-crm::lang.quotes')) }}</a>
                @endcan
                @endhasquotesenabled
                @hasordersenabled
                @can('view crm orders')
                    <a class="dropdown-item" href="#orders" data-type="orders" data-action="{{ url(route('laravel-crm.orders.search')) }}">{{ ucfirst(__('my-crm::lang.orders')) }}</a>
                @endcan
                @endhasordersenabled
                @hasinvoicesenabled
                @can('view crm invoices')
                    <a class="dropdown-item" href="#invoices" data-type="invoices" data-action="{{ url(route('laravel-crm.invoices.search')) }}">{{ ucfirst(__('my-crm::lang.invoices')) }}</a>
                @endcan
                @endhasinvoicesenabled
                @hasdeliveriesenabled
                @can('view crm deliveries')
                    <a class="dropdown-item" href="#deliveries" data-type="deliveries" data-action="{{ url(route('laravel-crm.deliveries.search')) }}">{{ ucfirst(__('my-crm::lang.deliveries')) }}</a>
                @endcan
                @endhasdeliveriesenabled
                @haspurchaseordersenabled
                @can('view crm purchase orders')
                    <a class="dropdown-item" href="#purchase-orders" data-type="purchaseOrders" data-action="{{ url(route('laravel-crm.purchase-orders.search')) }}">{{ ucfirst(__('my-crm::lang.purchase_orders')) }}</a>
                @endcan
                @endhaspurchaseordersenabled
                @can('view crm clients')
                    <a class="dropdown-item" href="#clients" data-type="clients" data-action="{{ url(route('laravel-crm.clients.search')) }}">{{ ucfirst(__('my-crm::lang.clients')) }}</a>
                @endcan
                @can('view crm organisations')    
                <a class="dropdown-item" href="#organisations" data-type="organisations" data-action="{{ url(route('laravel-crm.organisations.search')) }}">{{ ucfirst(__('my-crm::lang.organizations')) }}</a>
                @endcan
                @can('view crm people')
                    <a class="dropdown-item" href="#people" data-type="people" data-action="{{ url(route('laravel-crm.people.search')) }}">{{ ucfirst(__('my-crm::lang.people')) }}</a>
                @endcan
                @can('view crm products')
                <a class="dropdown-item" href="#products" data-type="products" data-action="{{ url(route('laravel-crm.products.search')) }}">{{ ucfirst(__('my-crm::lang.products')) }}</a>
                @endcan
            </div>
        </div>
    </div>
