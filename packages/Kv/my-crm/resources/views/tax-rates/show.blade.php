            ...
            <div class="col col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0"> {{ ucfirst(__('my-crm::lang.tax_rate')) }}: {{ $taxRate->name }} <span class="float-right">
                            <a type="button" class="btn btn-outline-secondary btn-sm" href="{{ url(route('laravel-crm.tax-rates.index')) }}"><span class="fa fa-angle-double-left"></span> {{ ucfirst(__('my-crm::lang.back_to_tax_rates')) }}</a> | 
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 border-right">
                                ...
                                <hr />
                                <dl class="row">
                                    <dt class="col-sm-3 text-right">{{ ucfirst(__('my-crm::lang.rate')) }}</dt>
                                    ...
                                    <dt class="col-sm-3 text-right">{{ ucfirst(__('my-crm::lang.default_tax_rate')) }}</dt>
                                    <dd class="col-sm-9">{{ $taxRate->default == 1 ? 'YES' : 'NO' }}</dd>
                                    <dt class="col-sm-3 text-right">{{ ucfirst(__('my-crm::lang.tax_type')) }}</dt>
                                    <dd class="col-sm-9">{{ $taxRate->tax_type }}</dd>
                                </dl>
                            </div>
                            <div class="col-sm-6">
                                @can('view crm products')
                                    <h6 class="text-uppercase section-h6-title-table"><span>{{ ucfirst(__('my-crm::lang.products')) }} ({{ $taxRate->products->count() }})</span></h6>
