            ...
            <div class="col col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0">{{ ucfirst(__('my-crm::lang.role')) }}: {{ $role->name }} <span class="float-right">
                        ...
                        <div class="row">
                            <div class="col-sm-6 border-right">
                                ...
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-9">{{ ucfirst(__('my-crm::lang.yes')) }}</dd>
                                </dl>
                                <h6 class="text-uppercase mt-4">{{ ucfirst(__('my-crm::lang.permissions')) }}</h6>
                                <hr />
