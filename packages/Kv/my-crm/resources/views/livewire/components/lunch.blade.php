    ...
    <div class="card w-100 mb-2">
        <div class="card-body">
            ...
            <div class="media-body">
                <h5 class="mt-0 mb-1">{{ $lunch->name }} @include('my-crm::livewire.components.partials.lunch.actions', ['lunch' => $lunch])</h5>
                @if($showRelated)
                    <p class="pb-0 mb-2">
                        @if($lunch->lunchable instanceof \Kv\MyCrm\Models\Person)
                        ...
                        @elseif($lunch->lunchable instanceof \Kv\MyCrm\Models\Organisation)
                ...
                @endif
                @include('my-crm::livewire.components.partials.lunch.content', ['lunch' => $lunch])
            </div>
        </div>
    </div>
    @push('livewire-js')
