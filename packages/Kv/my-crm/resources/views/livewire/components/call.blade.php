    ...
    <div class="card w-100 mb-2">
        <div class="card-body">
            ...
            <div class="media-body">
                <h5 class="mt-0 mb-1">{{ $call->name }} @include('my-crm::livewire.components.partials.call.actions', ['call' => $call])</h5>
                @if($showRelated)
                    <p class="pb-0 mb-2">
                        @if($call->callable instanceof \Kv\MyCrm\Models\Person)
                        ...
                        @elseif($call->callable instanceof \Kv\MyCrm\Models\Organisation)
                ...
                @endif
                @include('my-crm::livewire.components.partials.call.content', ['call' => $call])
            </div>
        </div>
    </div>
    @push('livewire-js')
