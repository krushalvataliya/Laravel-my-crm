<div>
    @can('view crm contacts')
        <h6 class="text-uppercase mt-4 section-h6-title"><span>{{ ucfirst(__('my-crm::lang.people')) }} ({{ $contacts->count() }})</span>@can('create crm contacts') @if($actions) <span class="float-right"><a href="#" data-toggle="modal" data-target="#linkPersonModal" class="btn btn-outline-secondary btn-sm"><span class="fa fa-plus" aria-hidden="true"></span></a></span> @endif @endcan</h6>
        <hr />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="linkPersonModalLabel">{{ ucfirst(__('my-crm::lang.link_a_person')) }} </h5>
                    ...
                    <form wire:submit.prevent="link">
                        <div class="modal-body autocomplete">
                            ...
                            <div class="form-group @error('person_name') text-danger @enderror">
                                <label>{{ ucfirst(__('my-crm::lang.person_name')) }}</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button wire:click.prevent="link()" type="button" class="btn btn-primary">{{ ucwords(__('my-crm::lang.link_person')) }}</button>
                        </div>
                    </form>
                </div>
            </div>
