<span>
    @can('edit crm quotes')
        <a href="{{ route('laravel-crm.quotes.send',$this->quote) }}" data-toggle="modal" data-target="#quoteSendModal_{{ $this->quote->id }}" class="btn btn-outline-secondary btn-sm">{{ ucfirst(__('my-crm::lang.send')) }}</a>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="quoteSendModalLabel">{{ ucfirst(__('my-crm::lang.send_quote')) }} </h5>
